...
public class GridGameStartTests 
{
    ...
    public void Test51()
    {
        ...
        grid.Start();
        grid.Show(grid.GetCardId(0));
        grid.GetCard(grid.GetCardId(0)).State.Should().Be(CardState.Visible);
    }
    ...
    public void Test91()
    {
        ...
        grid.GetCard(grid.GetCardId(0)).State.Should().Be(CardState.Visible);
        grid.GetCard(grid.GetCardId(1)).State.Should().Be(CardState.Visible);
        grid.GetCard(grid.GetCardId(2)).State.Should().Be(CardState.Hidden);
    }
